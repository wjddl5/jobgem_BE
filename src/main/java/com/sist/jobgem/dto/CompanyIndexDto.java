...
public class CompanyIndexDto {
    ...
    private CompanyIndexDto(CompanyDto company, int postCount, int noPostCount, int reviewCount, int interviewCount, int talentCount, int fitJobseekerCount, List<BlockResponseDto> blockList) {
